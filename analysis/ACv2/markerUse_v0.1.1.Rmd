...
Marker use study v0.1.1 is an exact replicaiton of the basic datesStudy, but with slightly different markers. Here the marker widths are: `r print(markerList)`.
