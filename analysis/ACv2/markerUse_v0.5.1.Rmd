...
Marker use study v0.5.1 is an exact replicaiton of the basic datesStudy, but with slightly different markers.
...
studyName <- "markerUse"
studyVersion <- "0-5-1"
overrideMarkerList <- c(7, 13, 21) # Someone managed to get marker width 8 for one question, not sure how
