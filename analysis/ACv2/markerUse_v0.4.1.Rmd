...
Marker use study v0.4.1 is an exact replicaiton of the basic datesStudy, but with slightly different markers.
...
studyName <- "markerUse"
studyVersion <- "0-4-1"
overrideMarkerList <- c(5, 15, 20) # Someone managed to get marker width 8 for one question, not sure how
