...
!TODO[Summarise task performance]
...
!TODO[summarise advisor performance] 
...
tmp <- AdvisedTrial %>%
  ...
  summarise(asExpected = honest > deceptive)

```

### Summary {.summary}

!TODO[Summarise WoA] (`r round(mean(tmp$asExpected) * 100, 2)`%) participants show a preference for the honest advisor. Formal testing of the hypothesis is below.
...
!TODO[Summarise WoA full breakdown]
...
!TODO[Summarise advisor group differences]
...
!TODO[Summarise advice rating effects]
...
!TODO[summarise distance observations]
