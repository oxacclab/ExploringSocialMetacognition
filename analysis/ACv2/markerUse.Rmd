...
Marker use study v0.0.1 provides the same markers as the datesStudy studies, but removes the by-decade labelling on the timeline. This doesn't appear to make much difference to participant preferences.
...
for (v in unique(PP$studyVersion)) {
  ...
  print(
    ggplot(tmp[!is.na(tmp$responseMarker) && tmp$decision == "first", ], 
