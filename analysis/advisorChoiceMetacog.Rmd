...
printMean(tmp$adviceType, 'Mean AiC pick rate', isProportion = T)
print('Choice proportion AiC vs. chance level (.5)')
...
printMean(tmp$adviceType, 'Mean AiC pick rate', isProportion = T)
print('Choice proportion AiC vs. chance level (.5) for mid-confidence trials')
