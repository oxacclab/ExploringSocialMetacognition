...
# Core Analysis Script {.tabset .tabset-fade .tabset-pills}
...
* Test primary hypothesis (pick rates are not equal) 

* Test secondary hypothesis (influence is not equal)
